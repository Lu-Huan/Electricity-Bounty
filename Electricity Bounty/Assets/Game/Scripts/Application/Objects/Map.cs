...
public class Map : MonoBehaviour
{
    ...
    #region 字段
    public static int MapWidth = 12;//地图宽
    public static int MapHeight = 8;//地图高
    ...
    int[,] dir = new int[4, 2] { { 0, 1 }, { 0, -1 }, { 1, 0 }, { -1, 0 } };//方向
  
    Stack<Vector2> Road = new Stack<Vector2>();//用栈来存路径
    #endregion
    ...
    #region 事件
    public delegate void MapHandler(List<Tile> MapTiles, List<Vector3> MapPath);
    public event MapHandler MapComplete;
